...
bbduk.sh -Xmx80g in1=$processed_fastq_old1 in2=$processed_fastq_old2 out1=$unmatched_fastq1 out2=$unmatched_fastq2 outm1=$processed_fastq1 outm2=$processed_fastq2 ref=$ref_fasta k=31 hdist=3 stats=$filter_stats overwrite=TRUE t=$SLURM_CPUS_PER_TASK
fi
...
filter_stats='./preprocessed_fastq/'$sampname'_stats_filtering.txt'
bbduk.sh -Xmx80g in=$processed_fastq_old out=$unmatched_fastq outm=$processed_fastq ref=$ref_fasta k=31 hdist=3 stats=$filter_stats overwrite=TRUE t=$SLURM_CPUS_PER_TASK
else 
processed_fastq='./preprocessed_fastq/'$sampname'_preprocessed.fastq.gz'
fi
